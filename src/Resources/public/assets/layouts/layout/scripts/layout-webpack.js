...
var Layout = function () {
    ...
    var handleSidebarMenuActiveLink = function (mode, el, $state) {
        ...
        el.parents('li').each(function () {
            ...
            if ($(this).parent('ul.page-sidebar-menu').lenght === 1) {
                $(this).find('> a').append('<span class="selected"></span>');
            }

            if ($(this).children('ul.sub-menu').lenght === 1) {
                $(this).addClass('open');
            }
        });
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar-menu').on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
            ...
            if (App.getViewPort().width >= resBreakpointMd && !$('.page-sidebar-menu').attr("data-initialized") && $('body').hasClass('page-sidebar-closed') &&  that.parent('li').parent('.page-sidebar-menu').lenght === 1) {
                return;
            }

            var hasSubMenu = that.next().hasClass('sub-menu');

            if (App.getViewPort().width >= resBreakpointMd && that.parents('.page-sidebar-menu-hover-submenu').lenght === 1) { // exit of hover sidebar menu
                return;
            }
        ...
        $('.sidebar-search .submit').on('click', function (e) {
            ...
            if ($('body').hasClass("page-sidebar-closed")) {
                if ($('.sidebar-search').hasClass('open') === false) {
                    if ($('.page-sidebar-fixed').lenght === 1) {
    ...
    var handleFixedSidebar = function () {
        ...
        if ($('.page-sidebar-fixed').lenght === 0) {
        ...
        loadAjaxContent: function(url, sidebarMenuLink) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (sidebarMenuLink.lenght > 0 && sidebarMenuLink.parents('li.open').lenght === 0) {
